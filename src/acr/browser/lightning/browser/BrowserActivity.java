...
import acr.browser.lightning.R.attr;
import acr.browser.lightning.R.drawable;
import acr.browser.lightning.R.id;
import acr.browser.lightning.R.layout;
import acr.browser.lightning.R.string;
import acr.browser.lightning.R.style;
import acr.browser.lightning.bookmark.BookmarkManager;
import acr.browser.lightning.bookmark.BookmarkPage;
import acr.browser.lightning.history.HistoryDatabaseHandler;
import acr.browser.lightning.history.HistoryItem;
import acr.browser.lightning.history.HistoryPage;
import acr.browser.lightning.setting.SettingsActivity;
import acr.browser.lightning.setting.SettingsController;
import acr.browser.lightning.utils.Constants;
import acr.browser.lightning.utils.PreferenceConstants;
import acr.browser.lightning.utils.Utils;
import acr.browser.lightning.webview.ClickHandler;
import acr.browser.lightning.webview.LightningView;
import acr.browser.lightning.webview.SearchAdapter;
...
public class BrowserActivity extends Activity implements BrowserController {
	...
	// Control drawer-layout
	private DrawerLayout mDrawerLayout;
	
	// DrawerLayout on the Left - Tab-Drawer
	private ListView mDrawerListLeft;
	private RelativeLayout mDrawerLeft;
	
	// DrawerLayout on the Right - Setting-Drawer
	...
	/*
	 * If Orbot/Tor is installed, 
	 * prompt the user if they want to enable proxying for this session
	 */
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					switch (which) {
						...
						case DialogInterface.BUTTON_NEGATIVE:
							mPreferences
								.edit()
								.putBoolean(PreferenceConstants.USE_PROXY, false)
								.apply();
							break;
					}
				}
	...
	/**
	 * Set Navigation-Drawer-Width - depended on Screen-Width
	 */
	...
	/**
	 * displays the WebView contained in the LightningView 
	 * Also handles the removal of previous views
	 * 
	 * @param view
	 ...
	 * parameter String url  is the url that should have been obtained from the WebView touch node thingy, 
	 * if it is null, this method tries to deal with it and find a workaround
	 */
